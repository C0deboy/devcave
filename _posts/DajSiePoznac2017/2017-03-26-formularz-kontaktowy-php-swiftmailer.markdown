...
```
<hX>Gdzie:</hX>
- <code class="highlight"><span class="k">file_get_contents</span>()</code> - ta funkcja zwraca zawartość plików jako string. W naszym przypadku będzie to odpowiedź wygenerowana na podstawie danych w URL, które są przesyłane tak jak metodą GET, o której wspominałem <a href="{% post_url DajSiePoznac2017/2017-03-16-formularz-kontaktowy-HTML-JS %}#get-post">wcześniej</a>.
