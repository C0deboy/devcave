...
Po drodze, na potrzeby szkolne, wykonaliśmy z kolegą [aplikację webową](/moje-projekty#zwierciadła-i-soczewki) symulującą to szkolne rysowanie obrazów w zwierciadłach i soczewkach.
...
Zbliżały się wakacje, więc pomyślałem, że może znajdę jakieś praktyki żeby nabrać trochę doświadczenia. Niestety, mieszkam w Kielcach, gdzie jest bardzo mało ofert pracy dla programistów - tym bardziej Juniorów. O dziwo, była jedna oferta praktyk. Uradowany zaaplikowałem, jednak spóźniłem się, bo rekrutacja już się zakończyła. Zaproponowano mi, że jeśli czuję się na siłach to mogę zaaplikować na stanowisko Juniora. Nie czułem się na siłach i tego nie zrobiłem tego.
