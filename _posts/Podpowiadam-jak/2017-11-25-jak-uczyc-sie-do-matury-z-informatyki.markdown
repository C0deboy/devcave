...
Przeważnie do każdego zadania dostajemy plik (lub więcej) z danymi na których będziemy operować i które trzeba zaimportować do wykorzystywanego przez nas narzędzia.
...
- Dokonać obliczeń, najczęściej poprzez symulację, np. co będzie za X czasu jeśli Y
- Wyodrębnić skrajne przypadki
- Zrobić zestawienie jakichś konkretnych danych, które spełniają dany warunek
- W przypadku Accessa, stworzenie odpowiednich relacji między danymi, co jest kluczowe
- Zrobić wykres
...
Na początku polecam zaprzyjaźnć się z zadaniami maturalnymi ze [zbioru zadań od CKE](https://www.cke.edu.pl/egzamin-maturalny/egzamin-w-nowej-formule/materialy-dodatkowe/materialy-dla-uczniow-i-nauczycieli/zbiory-zadan/). Mamy udostępnione również dane i rozwiązania, więc jest to idealny sposób na naukę w pojedynkę - jako samouk. Jest tego całkiem sporo. Po przeklepaniu takiej ilości zadań powinieneś już biegle władać Excelem i Accessem, **co jest najważniejszą i najbardziej kluczową umiejętnością na maturze**. W prawdziwym świecie raczej te umiejętności Ci się nie przydadzą, szczególnie Access, ale na maturze liczy się czas i sprawne poruszanie się w tych programach jest ważne, jeśli liczysz na dobry wynik. Zresztą byłbyś tutaj, jeśli byłoby inaczej?
